...
###### df.dtypes
```
Retroune les types de colonnes.
```
###### df.info
```
...
```
A l'observation de l'histogramme et de la loi théorique, nous voyons que les données observés ne suivent pas parfaitement la loi théorique.
